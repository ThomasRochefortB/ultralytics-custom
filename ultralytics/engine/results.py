...
class Results(SimpleClass):
    ...
    def __init__(self, orig_img, path, names, boxes=None, masks=None, probs=None, keypoints=None, regression_preds = None, obb=None) -> None:
        ...
        self.regression_preds = regression_preds
